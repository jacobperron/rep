...
One additional parameter that can be included is ``--response-time``, which should print the delay between the time the client sent the request and the server sent the response.
